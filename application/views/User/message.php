 ...
 <div class="mail-box">
                              ...
                              <div class="modal-dialog">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form role="form"  method="POST" class="form-horizontal" enctype="multipart/form-data"  action="<?php echo base_url() ?>User/Send_message">
                  ...
                  <aside class="lg-side">
                      ...
                      <div class="inbox-body" >
                           ...
                           <?php if(!empty($msg)) { echo "Message sent successfully";  } else { echo "  "; }   ?>
                         ...
                         <div style=" background-color: blue; height: 90%">
                            ...
                            <tbody>
                              ...
                              <?php foreach ($inbox as $key => $value) {
                                ?>
                                   ...
                                   <form method="POST" action="<?php echo base_url() ?>User/multidelete">

                                  <tr class="unread" >
                                  <td class="inbox-small-cells">
                                      <input type="checkbox" value="<?php echo $value->msg_id ?>" name = "chk[]" class="mail-checkbox">
                                  </td>
                                <!--   <td class="inbox-small-cells"><i class="fa fa-star"></i></td> -->
                                 <td class="view-message  dont-show" ><?php echo $value->sender_id   ?></td>
        ...
        <tr> <td> <input type="submit" name="mult_delete" value="DELETE"> </td> </tr>
